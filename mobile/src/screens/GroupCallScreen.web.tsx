...
export function GroupCallScreen({ route, navigation }: Props) {
  ...
  return (
    <View style={styles.root}>
      <Text style={styles.kicker}>{kind === 'video' ? 'Appel vidéo de groupe' : 'Appel audio de groupe'}</Text>
      <Text style={styles.title}>{title}</Text>
      <Text style={styles.text}>Les appels de groupe audio et vidéo sont disponibles dans l’application mobile NexChat.</Text>
